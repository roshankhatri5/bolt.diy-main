...
bolt.diy is the official open-source version of Bolt.new that allows you to choose the LLM provider for each prompt! Currently, you can use models from **19+ providers** including OpenAI, Anthropic, Google/Gemini, Ollama, OpenRouter, LMStudio, Mistral, xAI, HuggingFace, DeepSeek, Groq, Cohere, Together AI, Perplexity AI, Hyperbolic, Moonshot AI (Kimi), Amazon Bedrock, GitHub Models, and more - with easy extensibility to add any other model supported by the Vercel AI SDK!

This is a comprehensive AI-powered development environment that runs entirely in your browser, providing a complete toolkit for modern web development with intelligent assistance at every step.
...
- **AI-powered full-stack web development** directly in your browser with WebContainer technology and live preview
- **Multi-provider AI support** with 19+ LLM providers and extensible architecture for additional models
- **Multi-modal prompting** - Attach images, files, and use voice input for comprehensive contextual understanding
- **Complete development environment** with integrated editor, terminal, file system, and real-time code execution
- **Advanced version control** with Git integration, GitHub connectivity, visual diff views, and collaborative workflows
- **Flexible deployment options** - One-click deployments to Vercel, Netlify, GitHub Pages, or Cloudflare Pages
- **Cross-platform desktop app** built with Electron for native experience on Windows, macOS, and Linux
- **Full-stack backend integration** with Supabase for authentication, database management, and real-time features
- **Data visualization and analysis** with interactive charts, graphs, and analytics tools using Chart.js
- **Enhanced AI capabilities** via MCP (Model Context Protocol) for external tool and service integration
- **Intelligent code management** with file/folder locking, conflict prevention, and change tracking systems
- **Advanced search and navigation** with full codebase indexing, fuzzy search, and intelligent code discovery
- **Mobile and cross-platform development** with Expo integration for React Native projects
- **Rich template ecosystem** with pre-configured setups for React, Vue, Next.js, Astro, and more
- **Team collaboration features** including project sharing, chat management, and synchronization tools
- **Professional development tools** with syntax highlighting, auto-completion, debugging, and testing support
